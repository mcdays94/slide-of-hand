...
describe("<ProgressBar> with showSlideIndicators=true (default)", () => {
  ...
  it("is visible by default (data-visible=true, opacity-100)", () => {
    render(
      <SettingsProvider initialSettings={{ showSlideIndicators: true, presenterNextSlideShowsFinalPhase: false, notesDefaultMode: "rich", deckCardHoverAnimation: { enabled: true, slideCount: 3 }, aiAssistantModel: "kimi-k2.6" }}>
...
describe("<ProgressBar> with showSlideIndicators=false", () => {
  ...
  it("is hidden by default (data-visible=false, opacity-0, pointer-events-none)", () => {
    render(
      <SettingsProvider initialSettings={{ showSlideIndicators: false, presenterNextSlideShowsFinalPhase: false, notesDefaultMode: "rich", deckCardHoverAnimation: { enabled: true, slideCount: 3 }, aiAssistantModel: "kimi-k2.6" }}>
        <ProgressBar total={5} current={0} />
      </SettingsProvider>,
    );
    const bar = screen.getByTestId("progress-bar");
