  ...
  return (
    <div className="relative flex h-full w-full items-center overflow-hidden bg-cf-bg-100">
      ...
      >
        ...
        >
          <span className="text-cf-orange">Zero Trust</span>{" "}
          <span className="opacity-30">×</span> <span>AI</span>
        </motion.h1>
        ...
        >
          Govern, secure, and unleash AI without slowing your team down.
          Discover shadow AI, control prompts, audit guardrail events,
          and ship MCP-powered agents. All on Cloudflare's network.
        </motion.p>
      ...
      {/* Right-side orbital decoration: dashed arc (slowly rotating), inner
          ...
          centred over the whole composition. */}
      <motion.div
      ...
      >
        <div className="relative h-[520px] w-[520px]">
          ...
          >
            <img
              src="/cf-zt-ai/logos/cloudflare-design.svg"
              alt="Cloudflare"
